...
#HOST = player2
#HOST = player3
#HOST = player4 #change name to match current host
...
s.bind((HOST, TCP_PORT)) #Set to Current player
s.listen(1)
...
#this sets the screen black and hides the mouse
...
while True:
    ...
    if vid == '101':
        os.system('killall omxplayer')
        time.sleep(.1)
        Popen(['omxplayer','-o','local',movie2])
        flag3 = 0
        time.sleep(1)
        #start checking to see if video is playing
        while flag3 == 0:
    ...
    if vid == '102':
        os.system('killall omxplayer')
        time.sleep(0.10)
        Popen(['omxplayer','-o','local',movie3])
        flag3 = 0
        time.sleep(1)
        #start checking to see if video is playing
        while flag3 == 0:
    ...
    if vid == '103':
        os.system('killall omxplayer')
        time.sleep(0.10)
        Popen(['omxplayer','-o','local',movie4])
        flag3 = 0
        time.sleep(1)
        #start checking to see if video is playing
        while flag3 == 0:
    ...
    if vid == '104':
        os.system('killall omxplayer')
        time.sleep(0.10)
        Popen(['omxplayer','-o','local',movie5])
        flag3 = 0
        time.sleep(1)
        #start checking to see if video is playing
        while flag3 == 0:
    ...
    if vid == '105':
        os.system('killall omxplayer')
        time.sleep(0.10)
        Popen(['omxplayer','-o','local',movie6])
        flag3 = 0
        time.sleep(1)
        #start checking to see if video is playing
        while flag3 == 0:
